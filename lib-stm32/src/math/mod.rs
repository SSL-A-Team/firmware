...
pub trait Number: Copy + Num + PartialOrd + PartialEq + FromPrimitive + ToPrimitive + defmt::Format {}

impl<T> Number for T where T: Copy + Num + PartialOrd + PartialEq + FromPrimitive + ToPrimitive + defmt::Format {}
