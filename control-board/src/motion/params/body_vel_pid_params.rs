...
pub static BODY_ACC_LIM: Vector3<f32> = vector![5.0, 2.0, 36.0];  // TODO calibrate/ignore
pub static BODY_DEACC_LIM: Vector3<f32> = vector![5.0, 5.0, 36.0];  // TODO calibrate/ignore
