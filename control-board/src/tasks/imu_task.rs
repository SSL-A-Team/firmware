...
async fn imu_task_entry(mut imu: Bmi085<'static, 'static, ImuSpi>, mut _accel_int: ExtiInput<'static, ImuAccelIntPin>, mut gyro_int: ExtiInput<'static, ImuGyroIntPin>) {
...
pub fn start_imu_task(spawner: &Spawner, 
    ...
    let imu_buf = IMU_BUFFER_CELL.get();
