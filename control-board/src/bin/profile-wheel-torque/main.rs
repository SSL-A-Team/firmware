...
//!
//! Companion to CURRENT_SENSING_INVESTIGATION.md. A lever arm is clamped to the
//! motor shaft and rests on a kitchen scale; the rotor is therefore stalled. The
...
const STALL_VIOLATION_RADS: f32 = 1.0;
