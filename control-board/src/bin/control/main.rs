...
async fn main(main_spawner: embassy_executor::Spawner) {
    ...
    defmt::info!(
        ...
        gv::FIRMWARE_HASH[0], gv::FIRMWARE_HASH[1],
        gv::FIRMWARE_HASH[2], gv::FIRMWARE_HASH[3],
        gv::FIRMWARE_DIRTY,
    );
    defmt::info!(
        "controls  hash={:02x}{:02x}{:02x}{:02x} dirty={}",
        gv::CONTROLS_HASH[0], gv::CONTROLS_HASH[1],
        gv::CONTROLS_HASH[2], gv::CONTROLS_HASH[3],
        gv::CONTROLS_DIRTY,
    );
    defmt::info!(
        "coms      hash={:02x}{:02x}{:02x}{:02x} dirty={}",
        gv::COMS_HASH[0], gv::COMS_HASH[1],
        gv::COMS_HASH[2], gv::COMS_HASH[3],
        gv::COMS_DIRTY,
    );
