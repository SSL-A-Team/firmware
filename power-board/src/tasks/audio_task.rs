use ateam_lib_stm32::{
    audio::{songs::SongId, tone_player::TonePlayer, AudioCommand},
    drivers::audio::buzzer::Buzzer,
};
...
use crate::{
    pins::*,
    songs::{
        BALANCE_CONNECTED_SONG, BALANCE_DISCONNECTED_SONG, BATTERY_CRITICAL_SONG, BATTERY_LOW_SONG,
        BATTERY_UH_OH_SONG, POWER_OFF_SONG, POWER_ON_SONG, SHUTDOWN_REQUESTED_SONG, TEST_SONG,
    },
};
...
pub fn start_audio_task(
    ...
    buzzer_pin: Peri<'static, BuzzerPwmPin>,
    buzzer_timer: Peri<'static, BuzzerTimer>,
) {
    let ch1 = PwmPin::new(buzzer_pin, OutputType::PushPull);
