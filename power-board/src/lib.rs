...
pub fn adc_raw_to_mv(sample: u16) -> f32 {
    (sample as f32 / 4096.0) * ADC_VREF_EXT * MV_PER_V
}

pub fn adc_raw_vrefint_to_mv(sample: u16, vrefint_sample: u16) -> f32 {
    // From https://www.st.com/resource/en/datasheet/stm32g031g8.pdf
    // 6.3.3 Embedded internal reference voltage
    const VREFINT_MV: u32 = 1212; // mV

    (u32::from(sample) * VREFINT_MV / u32::from(vrefint_sample)) as f32
}