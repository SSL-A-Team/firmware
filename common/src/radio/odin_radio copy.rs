...
pub trait RadioInterfaceControl<DataRefRead: DataRefReadTrait, DataRefWrite: DataRefWriteTrait>:
    Reader2<DataRefRead> + Writer2<DataRefWrite>
{
...
pub struct OdinRadio<
    'a,
    DataRefRead: DataRefReadTrait,
    DataRefWrite: DataRefWriteTrait,
    RadioInterface: RadioInterfaceControl<DataRefRead, DataRefWrite>,
> {
...
unsafe impl<
        ...
        DataRefWrite: DataRefWriteTrait,
        RadioInterface: RadioInterfaceControl<DataRefRead, DataRefWrite>,
    > Sync for OdinRadio<'a, DataRefRead, DataRefWrite, RadioInterface>
{
}
unsafe impl<
        'a,
        ...
        DataRefWrite: DataRefWriteTrait,
        RadioInterface: RadioInterfaceControl<DataRefRead, DataRefWrite>,
    > Send for OdinRadio<'a, DataRefRead, DataRefWrite, RadioInterface>
{
}

pub struct OdinSocket<
    'a,
    DataRefRead: DataRefReadTrait,
    DataRefWrite: DataRefWriteTrait,
    RadioInterface: RadioInterfaceControl<DataRefRead, DataRefWrite>,
> {
    radio: &'a OdinRadio<'a, DataRefRead, DataRefWrite, RadioInterface>,
    peer_id: u8,
}

impl<
        DataRefRead: DataRefReadTrait + 'static,
        DataRefWrite: DataRefWriteTrait + 'static,
        RadioInterface: RadioInterfaceControl<DataRefRead, DataRefWrite>,
    > Radio for OdinRadio<'static, DataRefRead, DataRefWrite, RadioInterface>
{
    type UdpSocket = OdinSocket<'static, DataRefRead, DataRefWrite, RadioInterface>;
...
impl<
        ...
        DataRefWrite: DataRefWriteTrait,
        RadioInterface: RadioInterfaceControl<DataRefRead, DataRefWrite>,
    > OdinRadio<'a, DataRefRead, DataRefWrite, RadioInterface>
{
...
impl<
        'a,
        DataRefRead: DataRefReadTrait + 'a,
        DataRefWrite: DataRefWriteTrait + 'a,
        RadioInterface: RadioInterfaceControl<DataRefRead, DataRefWrite> + 'a,
    > Task for OdinRadio<'a, DataRefRead, DataRefWrite, RadioInterface>
{
    type Data = &'a Self;
...
impl<
        ...
        DataRefWrite: DataRefWriteTrait,
        RadioInterface: RadioInterfaceControl<DataRefRead, DataRefWrite>,
    > UdpSocket for OdinSocket<'a, DataRefRead, DataRefWrite, RadioInterface>
{
